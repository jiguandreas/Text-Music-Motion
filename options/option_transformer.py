...
def get_args_parser():
    ...
    # text - music - motion 【新增的】
    parser.add_argument('--input_modality', type=str, choices=['text', 'music'], default='text',
                    help='Choose input modality for Transformer (text or music)')
